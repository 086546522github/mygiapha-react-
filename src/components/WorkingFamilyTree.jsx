...
import './WorkingFamilyTree.css';

const WorkingFamilyTree = ({ user, onNavigate }) => {
  ...
  useEffect(() => {
    const userKey = `working_tree_${user?.id || 'guest'}`;
  ...
  return (
    <div className="working-family-tree">
...
export default WorkingFamilyTree;
